    ...
    *,
    ...
    if language is None:
        if not model.is_multilingual:
            ...
            if verbose is not None:
                print(
                    f"Detected language: {LANGUAGES[language].title()}\n"
                )
    ...
    with tqdm.tqdm(
        ...
        while seek < content_frames:
            ...
            progress(float(seek / content_frames), desc="Process audio..")
...
def cli():
    ...
    parser.add_argument("--bmodel_dir", type=str, default="./models", help="the path to save model files; uses ./models by default")
    ...
    parser.add_argument("--initial_prompt", type=str, default="用简体中文回答", help="optional text to provide as a prompt for the first window.")
